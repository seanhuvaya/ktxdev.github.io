...
const Intro = forwardRef((props, ref) => (
    <div ref={ref} id='summary' className='w-full flex flex-col-reverse items-center px-5 md:px-10 lg:px-44 xl:px-60 pt-40 pb-20 md:py-48 text-center md:flex-row md:justify-center md:gap-28 md:text-left'>
        ...
        <img className='h-40 lg:h-56 xl:h-80' src={hero_image} alt="Hero" />
    </div>
))
