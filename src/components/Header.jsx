        ...
        <nav className='md:flex md:justify-between md:items-center py-4 px-5 md:px-40 font-roboto shadow'>
            <div className="flex justify-between items-center">
                ...
                <a href="https://ktxdev.com">
                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="none" viewBox="0 0 66 77">
                ...
                <button className="md:hidden" onClick={toggleMenu}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="none" viewBox="0 0 385 385">
            ...
            <div className="hidden md:flex space-x-4">
                ...
                <button className="border-2 border-red-500 text-red-500 rounded-2xl px-6" >Resume</button>
            </div>
