...
const Contact = forwardRef((props, ref) => {
    ...
    const inputStyle = 'w-full py-2 md:py-4 px-4 bg-red-100 placeholder:text-gray-700 outline-none rounded-md border border-red-300';

    return (
        <div ref={ref} className='w-full bg-gray-50 pt-16 lg:pt-24 px-5 md:px-20 lg:px-40 xl:px-96' >
