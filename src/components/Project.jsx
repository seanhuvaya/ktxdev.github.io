                ...
                <ul className='flex gap-2 md:gap-4 items-center' >
                    <li>
                        <a href={project.githubLink}>
                            <svg className="cursor-pointer group w-4 h-4 md:w-6 md:h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 35 35">
                    ...
                    <li>
                        <a href={project.liveLink}>
                            <svg className="cursor-pointer group w-5 h-5 md:w-8 md:h-8" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 260 260">
                                <g clip-path="url(#a)">
